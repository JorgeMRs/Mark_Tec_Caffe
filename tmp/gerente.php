...
<body>
                    ...
                    if (userRole === 'Admin') {
                        ...
                        document.querySelectorAll('.acciones').forEach(select => {
                            select.addEventListener('change', function() {
                                ...
                                if (action === 'modificar') {
                                    mostrarFormularioPedido('editModal', `/public/panel/obtener_pedido_por_id.php?id=${id}`, {
                                        idPedido: 'editId',
                    ...
                    if (userRole === 'Admin') {
                        ...
                        document.querySelectorAll('.acciones').forEach(select => {
                            select.addEventListener('change', function() {
                                ...
                                const action = select.value;
                                if (action === 'modificar') {
                                    mostrarFormulario('historialModal', `/public/panel/obtener_historial_por_id.php?id=${id}`, {
                                        idPedido: 'historialId',
                                        fechaPedido: 'historialFecha',
                                        idCliente: 'historialClienteNombre',
                    ...
                    if (userRole === 'Admin') {
                        ...
                        document.querySelectorAll('.acciones').forEach(select => {
                            select.addEventListener('change', function() {
                                ...
                                const action = select.value;
                                if (action === 'modificar') {
                                    mostrarFormulario('inventarioModal', `/public/panel/obtener_producto_por_id.php?id=${id}`, {
                    ...
                    if (userRole === 'Admin') {
                        ...
                        document.querySelectorAll('.acciones').forEach(select => {
                            select.addEventListener('change', function() {
                                ...
                                const action = select.value;
                                if (action === 'modificar') {
                                    mostrarFormularioPersonal('personalModal', `/public/panel/obtener_empleado_por_id.php?id=${id}`, {
                    ...
                    if (userRole === 'Admin') {
                        ...
                        document.querySelectorAll('.acciones').forEach(select => {
                            select.addEventListener('change', function() {
                                ...
                                const action = select.value;
                                if (action === 'modificar') {
                                    mostrarFormularioReserva('reservaModal', `/public/panel/obtener_reserva_por_id.php?id=${id}`, {
                                        id: 'reservaId',
                    ...
                    if (userRole === 'Admin') {
                        ...
                        document.querySelectorAll('.acciones').forEach(select => {
                            select.addEventListener('change', function() {
                                ...
                                const action = select.value;
                                if (action === 'modificar') {
                                    mostrarFormulario('categoriaModal', `/public/panel/obtener_categoria_por_id.php?id=${id}`, {
                ...
                fetch(`/public/panel/eliminar_reserva.php?id=${id}`, {
                    ...
                    .then(data => {
                        if (data.success) {
                            ...
                            cargarDatosReservas('/public/panel/obtener_reservas.php', 'reservalItems');
                        } else {
    ...
    fetch('/public/panel/obtener_resumen.php')
        .then(response => response.json())
        .then(data => {
            // Convertir ventasDelDia a un número
            const ventasDelDia = parseFloat(data.ventasDelDia);
            document.getElementById('ventasDelDia').textContent = `$${ventasDelDia.toFixed(2)}`;
        ...
        .catch(error => console.error('Error al obtener los datos:', error));
            ...
            fetch('/public/panel/obtener_productos_mas_vendidos.php')
                .then(response => response.json())
                .then(data => {
            ...
            fetch('/public/panel/obtener_tendencia_ventas.php')
                .then(response => response.json())
                .then(data => {
            ...
            fetch('/public/panel/obtener_distribucion_ventas.php')
                .then(response => response.json())
                .then(data => {
            ...
            fetch('/public/panel/obtener_rendimiento_empleados.php')
                .then(response => response.json())
                .then(data => {
