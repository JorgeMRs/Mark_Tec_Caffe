...
document.getElementById('logout-link').addEventListener('click', function(event) {
                    ...
                    if (userRole === 'Admin') {
                        ...
                        document.querySelectorAll('.acciones').forEach(select => {
                            select.addEventListener('change', function() {
                                ...
                                const action = select.value;
                                if (action === 'modificar') {
                                    mostrarFormularioHistorial('historialModal', `/public/panel/obtener_historial_por_id.php?id=${id}`, {
                    ...
                    if (userRole === 'Admin') {
                        ...
                        document.querySelectorAll('.acciones').forEach(select => {
                            select.addEventListener('change', function() {
                                ...
                                const action = select.value;
                                if (action === 'modificar') {
                                    mostrarFormularioCategoria('categoriaModal', `/public/panel/obtener_categoria_por_id.php?id=${id}`, {
        ...
        function actualizarGraficoVentasSemanales(week) {
            fetch(`/public/panel/obtener_ventas_semanales.php?week=${week}`)
                .then(response => response.json())
                .then(data => {
