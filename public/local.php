...
// Datos de ubicaciones reales en Portugal, España, Alemania y Francia
$locations = [
    [
        'id' => 1,
            ...
            <section class="locales-grid">
                <?php foreach ($locations as $local): ?>
                    <div class="local-card">
                        <div class="local-image" style="background-image: url('/public/assets/img/<?php echo strtolower($local['pais']); ?>.jpg');">
